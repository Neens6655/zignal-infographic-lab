    ...
    async start(controller) {
      ...
      try {
        ...
        saveGeneration({
          ...
          credibilityScore: result.provenance?.credibility?.overall,
          claimsTotal: result.provenance?.credibility?.claimsTotal,
          claimsCrossVerified: result.provenance?.credibility?.claimsCrossVerified,
          researchProviders: [...new Set(result.provenance?.research?.citations?.map(c => c.provider) || [])],
